...
public class GameManager : MonoBehaviour
{
    ...
    private void Update()
    {
        // Detecta la tecla 'R' solo si el panel de Game Over est� activo
        ...
        // Detecta la tecla 'Enter' para ejecutar otra acci�n (puedes personalizar la acci�n aqu�)
        if (gameOverPanel.activeSelf && Input.GetKeyDown(KeyCode.M)) // Tambi�n puede ser KeyCode.KeypadEnter para teclados num�ricos
        {
            Debug.Log("Acci�n con Enter ejecutada.");
    ...
    public void TakeDecision(Decision decision)
    {
        ...
        // Validaci�n para que no se pase de 100%
    ...
    private void EndHalfYearReport()
    {
        ...
        {
            reportSatisfactionFinalText.text = "Lograste mantenerte, pero la satisfacci�n del usuario es baja.";
        }
        else
        {
